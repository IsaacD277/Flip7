...
## Getting Started
1. Run the file locally on your computer.
2. Select the number of players
3. Input their names in turn order
4. Choose whether you want to "cheat" and see your chances of busting each turn and the expected value of the next card.
5. BEGIN!
